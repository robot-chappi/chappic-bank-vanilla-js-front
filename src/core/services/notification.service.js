const { $C } = require('../cquery/cquery.lib')
...
export class NotificationService {
	 ...
	 * @returns {('success'|'error')} type - The type of the notification, only 'success' or 'error' are accepted.
	 */
	show(type, message) {
		...
		const notificationElement = $C('#notification')

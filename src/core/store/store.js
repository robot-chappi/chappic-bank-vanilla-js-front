...
/**
 * Store class implements tje Singleton pattern, providing a centralized storage and state management solution.
...
export class Store {
	...
	/**
	 * Update user profile and the storage state.
	 * @param {Object} user - The user object to update state.
	 */
	updateProfile(user) {
		this.state.user = user
		this.storageService.setItem(USER_STORAGE_KEY, user)
